...
public class ProductoService {
        ...
        if (!imagenFile.isEmpty()) { //Si no está vacío... pasaron una imagen...            
            try {
                String rutaImagen = firebaseStorageService.uploadImage(
                        imagenFile, "producto", //PARA GUARDAR EL PRODUCTO EN OTRO ALMACENAMIENTO DEL FIREBASE
    ...
    @Transactional(readOnly = true)
    public List<Producto> consulta4(Integer existenciasInf, Integer existenciasSup) {
        return productoRepository.consulta4(existenciasInf, existenciasSup);
    }
