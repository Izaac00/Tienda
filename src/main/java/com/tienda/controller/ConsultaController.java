...
public class ConsultaController {
    ...
    public String consulta4(@RequestParam() Integer existenciasInf,
            @RequestParam() Integer existenciasSup,
            Model model) {
        var productos = productoService.consulta4(existenciasInf, existenciasSup);
        model.addAttribute("productos", productos);
